...
- `<ModalProject>` | `<modal-project>` (components/Modal/Project.vue)
- `<ModalViewProjectDISABLED>` | `<modal-view-project-d-i-s-a-b-l-e-d>` (components/Modal/ViewProjectDISABLED.vue)
